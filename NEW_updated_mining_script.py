...
# TODO Check if this is used anywhere - if not delete it.
...
for page in range(1, last_page_number + 1):
    url = f'https://www.imoti.net/bg/obiavi/r/prodava/sofia/?page={page}&sid=fZ1ULc'
    urls.append(url)
    ...
    for link in links:
        ...
        for one_offer in soup1.find_all('li', {'class': 'clearfix'}):
            ...
            for each_sub_price in price_arr:
                final_price += int(each_sub_price)
            intermediate_prices.append(float(final_price))
...
print(len(link_for_offer))
print(sqm_area)
print(len(sqm_area))
print(locations)
print(len(locations))
print(location_area)
print(len(location_area))
print(property_type)
